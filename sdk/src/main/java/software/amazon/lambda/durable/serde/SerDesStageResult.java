 ...
 * @param skipRemainingStages whether deserialization should skip the remaining stages and decode {@code value} as an
 *     external string with the pipeline's value codec
 */
public record SerDesStageResult(Object value, boolean skipRemainingStages) {
    ...
    /** Skips the remaining stages and decodes the external string with the pipeline's value codec. */
