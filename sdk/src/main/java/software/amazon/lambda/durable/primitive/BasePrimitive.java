...
public abstract class BasePrimitive {
    private static final Logger logger = LoggerFactory.getLogger(BasePrimitive.class);

    private final OperationIdentifier operationIdentifier;
    protected final ExecutionManager executionManager;
    protected final CompletableFuture<BasePrimitive> completionFuture;
    ...
    protected BasePrimitive(
            OperationIdentifier operationIdentifier, DurableContextImpl durableContext, BasePrimitive parentOperation) {
    ...
    public CompletableFuture<BasePrimitive> getCompletionFuture() {
