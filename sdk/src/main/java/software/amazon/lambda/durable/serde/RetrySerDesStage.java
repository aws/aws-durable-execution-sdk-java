 ...
 */
public final class RetrySerDesStage implements SerDesStage {
     ...
     */
    public RetrySerDesStage(SerDesStage delegate, RetryStrategy retryStrategy) {
        this(delegate, retryStrategy, SerDesRetryExecutor.DEFAULT_SLEEPER);
    }

    RetrySerDesStage(SerDesStage delegate, RetryStrategy retryStrategy, SerDesRetryExecutor.Sleeper sleeper) {
    ...
    public String serialize(String value, SerDesContext context) {
        return retryExecutor.execute("string stage serialization", () -> delegate.serialize(value, context));
    }

    @Override
    public String deserialize(String data, SerDesContext context) {
        return retryExecutor.execute("string stage deserialization", () -> delegate.deserialize(data, context));
    }
}
