...
/**
 * Unit tests verifying that BaseDurableOperation.execute() fires onOperationStart with isReplay=true for all
 * non-terminal operations during replay, regardless of operation type.
 *
 * <p>This mirrors the Python SDK's TestPluginExecutorOnOperationReplay tests.
 */
class BaseDurableOperationPluginTest {
