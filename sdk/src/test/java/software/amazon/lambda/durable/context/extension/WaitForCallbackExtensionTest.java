...
class WaitForCallbackExtensionTest {
    @Test
    void executeCreatesExistingWaitForCallbackContextTopology() {
        ...
        var actual = WaitForCallbackExtension.execute(
                context, "approval", resultType, (callbackId, stepContext) -> {}, config);
    ...
    void errorHandlerPreservesCallbackTimeoutException() {
        ...
        WaitForCallbackExtension.execute(
                context,
                "approval",
                resultType,
