 ...
 * @param startedAt when the task started, when available; currently empty because the extension SPI does not expose
 *     operation timestamps
 * @param completedAt when the task completed, when available; currently empty because the extension SPI does not expose
 *     operation timestamps
