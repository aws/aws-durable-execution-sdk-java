...
def render_file_system_infrastructure_template() -> str:
    lines = [
        ...
        "Description: Persistent EFS infrastructure for filesystem SerDes E2E tests",
        "",
        "Resources:",
    ]
    ...
    if any(example.file_system for example in examples):
        lines.extend(
            [
                ...
                "    Type: String",
                "    Description: Name of the persistent filesystem SerDes E2E infrastructure stack",
            ]
        )
    lines.extend(
        [
...
def main() -> None:
    ...
    template_selection.add_argument(
        ...
        action="store_true",
        help="Generate the persistent EFS infrastructure stack used by filesystem SerDes E2E tests.",
    )
