...
public class ChildContextExample extends DurableHandler<GreetingRequest, String> {
    ...
    public String handleRequest(GreetingRequest input) {
        ...
        var orderFuture = DurableContextOperation.runInChildContextAsync("order-validation", String.class, () -> {
        ...
        var inventoryFuture = DurableContextOperation.runInChildContextAsync("inventory-check", String.class, () -> {
            var stock = DurableStepOperation.step("check-stock", String.class, () -> "Stock available for " + name);
        ...
        var shippingFuture = DurableContextOperation.runInChildContextAsync("shipping-estimate", String.class, () -> {
            var baseRate =
                    DurableStepOperation.step("calculate-base-rate", String.class, () -> "Base rate for " + name);
            ...
            return DurableStepOperation.step("finalize-shipping", String.class, () -> adjustment + " [shipping ready]");
        });
