...
public class OtelXRayExecutionStepExample extends DurableHandler<GreetingRequest, String> {
    ...
    public String handleRequest(GreetingRequest input) {
        ...
        var greeting =
                DurableStepOperation.step("exec-create-greeting", String.class, () -> "Hello, " + input.getName());

        var result = DurableStepOperation.step("exec-transform", String.class, () -> greeting.toUpperCase() + "!");
