...
For value codecs, composable string and binary stages, stage context, retry and executor behavior, test-runner input
codecs, and filesystem-backed payload storage, see
[Serialization and SerDes pipelines](serdes.md).
